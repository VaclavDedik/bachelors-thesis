...
There are a lot of other technologies used for the implementation of the Thesis Management System, but since they are not crucial for a good comprehension of this thesis, they will be described only briefly.
